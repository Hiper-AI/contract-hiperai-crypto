...
/// @custom:security-contact cryptosecurity@hiperai.com
contract HiperAI is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address initialOwner) initializer public {
        __ERC20_init("Hiper AI", "HIPERAI");
        __ERC20Burnable_init();
        __ERC20Pausable_init();
        __Ownable_init(initialOwner);
        __UUPSUpgradeable_init();

        _mint(msg.sender, 602000000000000000000000 * 10 ** decimals());
    }
